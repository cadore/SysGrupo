...
namespace SysFileManager.Utils.Botoes
{
    public class BotaoDownload : Button
    {
        public BotaoDownload()
        {
            ...
            this.Image = global::SysFileManager.Properties.Resources.download;
